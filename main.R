...
# SciDB 15.12 iquery -aq "stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62400, 43200, 15), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=analyzeTS.R', 'format=df', 'types=int32,int32,int32,int32,int32')"
# SciDB 16.9  iquery -aq "stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62400, 43200, 15), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799:0:40; row_id=0:86399:0:40; time_id=0:511:0:512]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=analyzeTS.R', 'format=df', 'types=int32,int32,int32,int32,int32')"
## Response
...
# SciDB 15.12 iquery -aq "stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62402, 43202, 15), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=analyzeTS.R', 'format=df', 'types=int32,int32,int32,int32,int32')"
# SciDB 16.9  iquery -aq "stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62402, 43202, 15), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799:0:40; row_id=0:86399:0:40; time_id=0:511:0:512]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=analyzeTS.R', 'format=df', 'types=int32,int32,int32,int32,int32')"
#
## EXAMPLE 3:  Same as example 2 but it redimension the answer to a 2D array
# SciDB 15.12 iquery -aq "redimension(stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62402, 43202, 15), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=analyzeTS.R', 'format=df', 'types=int32,int32,int32,int32,int32', 'names=col_id,row_id,nrow,ncol,lenjson'), <nrow:int32, ncol:int32, lenjson:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0])"
# SciDB 16.9  iquery -aq "redimension(stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62402, 43202, 15), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799:0:40; row_id=0:86399:0:40; time_id=0:511:0:512]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=analyzeTS.R', 'format=df', 'types=int32,int32,int32,int32,int32', 'names=col_id,row_id,nrow,ncol,lenjson'), <nrow:int32, ncol:int32, lenjson:int32> [col_id=0:172799:0:40; row_id=0:86399:0:40])"
#
...
# SciDB 15.12 iquery -aq "redimension(stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62402, 43202, 15), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=analyzeTS.R', 'format=df', 'types=int32,int32,int32,int32,int32', 'names=col_id,row_id,nrow,ncol,lenjson'), <nrow:int32, ncol:int32, lenjson:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0])"
...
# SciDB 15.12 iquery -aq "stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62409, 43209, 511), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=bfastMonitor.R', 'format=df', 'types=int32,int32,double,string')"
# SciDB 16.9  iquery -aq "stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62409, 43209, 511), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799:0:40; row_id=0:86399:0:40; time_id=0:511:0:512]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=bfastMonitor.R', 'format=df', 'types=int32,int32,double,string')"
#
## EXAMPLE 6: Same as example 5, but it redimensions the query response to a 2D array
# SciDB 15.12 iquery -aq "redimension(stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62409, 43209, 511), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=bfastMonitor.R', 'format=df', 'types=int32,int32,double,string', 'names=col_id,row_id,breakpoint,breakpointStr'), <breakpoint:double, breakpointStr:string> [col_id=0:172799,40,0; row_id=0:86399,40,0])"
# SciDB 16.9  iquery -aq "redimension(stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62409, 43209, 511), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799:0:40; row_id=0:86399:0:40; time_id=0:511:0:512]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=bfastMonitor.R', 'format=df', 'types=int32,int32,double,string', 'names=col_id,row_id,breakpoint,breakpointStr'), <breakpoint:double, breakpointStr:string> [col_id=0:172799:0:40; row_id=0:86399:0:40])"
#
...
# SciDB 16.9 iquery -aq "redimension(stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62409, 43209, 511), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=bfastMonitor.R', 'format=df', 'types=int32,int32,double,string', 'names=col_id,row_id,breakpoint,breakpointStr'), <breakpoint:double, breakpointStr:string> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0])"
...
# SciDB 15.12 iquery -aq "stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62409, 43209, 511), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=kf4deforestation.R', 'format=df', 'types=int32,int32,double,string', 'names=col_id,row_id,breakpoint,breakpointStr')"
...
#
## EXAMPLE 9: A SciDB query runs the KALMAN FILTER on 100 time series and redimensions to 2D
# SciDB 15.12 iquery -aq "redimension(stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62409, 43209, 511), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799,40,0; row_id=0:86399,40,0; time_id=0:511,512,0]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=kf4deforestation.R', 'format=df', 'types=int32,int32,double,string', 'names=col_id,row_id,breakpoint,breakpointStr'), <breakpoint:double, breakpointStr:string> [col_id=0:172799,40,0; row_id=0:86399,40,0])"
# SciDB 16.9  iquery -aq "redimension(stream(cast(project(apply(between(MOD13Q1, 62400, 43200, 0, 62409, 43209, 511), cid, col_id, rid, row_id, tid, time_id), cid, rid, tid, evi, quality, reliability), <cid:int32, rid:int32, tid:int32, evi:int32, quality:int32, reliability:int32> [col_id=0:172799:0:40; row_id=0:86399:0:40; time_id=0:511:0:512]), 'Rscript /home/scidb/shared/scripts/sdbStreamR4ts/main.R script_folder=/home/scidb/shared/scripts/sdbStreamR4ts script_name=kf4deforestation.R', 'format=df', 'types=int32,int32,double,string', 'names=col_id,row_id,breakpoint,breakpointStr'), <breakpoint:double, breakpointStr:string> [col_id=0:172799:0:40; row_id=0:86399:0:40])"
################################################################################
...
if(is.na(script_folder) || is.na(script_name)){
  write(paste0(format(Sys.time()), " ERROR: Invalid parameters (main.R)"), stderr())
  stop("Invalid parameters!")
}
#---- 2 - cast sdb chunk to data.frame ----
